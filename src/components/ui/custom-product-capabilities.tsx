...
const ICON_BY_KEY: Record<CapabilityKey, string> = {
  flavorProfiling: "/pattern/wheat-lime.png",
  formulation:     "/pattern/private-label-lime.png",
  sensoryTesting:  "/pattern/kag-monogram-lime.png",
  regulatoryLabel: "/pattern/export-globe-lime.png",
  pilotBatches:    "/pattern/manufacturing-lime.png",
  scaleUp:         "/pattern/distribution-truck-lime.png",
};

interface CustomProductCapabilitiesProps {
  eyebrow: string;
  heading: string;
  intro: string;
...
export default function CustomProductCapabilities({
  eyebrow,
  heading,
  intro,
  items,
}: CustomProductCapabilitiesProps) {
