...
const STEP_FIELDS: readonly (readonly FieldPath<PrivateLabelRfqInput>[])[] = [
  CONTACT_FIELDS as readonly FieldPath<PrivateLabelRfqInput>[],
  PRIVATE_LABEL_FIELDS as readonly FieldPath<PrivateLabelRfqInput>[],
  SHIPPING_FIELDS as readonly FieldPath<PrivateLabelRfqInput>[],
  [],
];
...
export function PrivateLabelWizard() {
  ...
  const methods = useForm<PrivateLabelRfqInput>({
    ...
    defaultValues: {
      ...
      isExport: undefined as unknown as boolean,
